...
@Composable
private fun DirectionBlock(arrival: ArrivalModel) {
    Box(
        modifier = GlanceModifier
            .fillMaxSize()
        ...
        val destinationDouble = arrival.destinationName.length > 8
        Box(
            modifier = GlanceModifier
                .fillMaxSize()
...
@Composable
private fun IdentifierColumn(arrival: ArrivalModel) {
    Column(
        modifier = GlanceModifier
            .fillMaxSize()
    ) {
