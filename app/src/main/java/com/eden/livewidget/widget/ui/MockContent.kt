...
fun MockContent() {
    ...
    MyContent(
        ...
        widgetId = -1,
        fromName = LocalContext.current.getString(R.string.widget_mock_station_text),
        toNames = listOf(
            LocalContext.current.getString(R.string.widget_ui_mockcontent_destination_0_name)
        ),
        agency = null,
