...
class DuplicatesDatabaseProvider(
    val apiProvider: Provider,
): CacheProvider {

    companion object {
        private const val DATABASE_NAME_BASE = "PointsCacheDuplicatesDatabase"
        ...
        private var currentDatabase: DuplicatesDatabase? = null
    ...
    private fun populateCache(
        database: DuplicatesDatabase,
        applicationContext: Context,
    ) {
        val messageClassName = DuplicatesDatabase::class.java.name
